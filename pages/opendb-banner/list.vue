<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="bannerfile,open_url,title,sort,status,description" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'open_url')" sortable @sort-change="sortChange($event, 'open_url')">跳转地址</uni-th>
