			...
			<uni-list-item class="item">
				<template v-slot:body>
					<view class="item">
						...
						<cloud-image @click="uploadAvatarImg" v-if="avatar_file" style="border-raduis: 50px;overflow:hidden;" :src="avatar_file.url" width="50px" height="50px"></cloud-image>
